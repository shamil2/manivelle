  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center font-sans">
      ...
      <section className="w-full min-h-[80vh] flex flex-col items-center justify-center px-8 relative">
        ...
        <p className="mt-8 text-lg md:text-xl text-primary/70 max-w-2xl text-center">
      ...
      <section className="w-full max-w-7xl px-8 py-24 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 relative">
             <div className="aspect-[3/4] bg-subtle rounded-sm overflow-hidden relative">
             ...
             <div className="aspect-[3/4] bg-subtle rounded-sm overflow-hidden relative translate-y-12">
